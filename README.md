<div style="display: flex; gap: 30px; flex-wrap: wrap; max-width: 1000px; margin: 0 auto;">
  <div style="flex: 0 0 220px; text-align: center;">
    ...
    <div style="margin-top: 15px; text-align: left; font-size: 14px;">
      <p><strong>🎓 Ruifeng Han</strong></p>
      <p>Artificial Intelligence</p>
      <p>Nanjing University of Information Science and Technology</p>
      <hr style="margin: 10px 0; opacity: 0.3">
      <p>📧 <a href="mailto:202312620009@nuist.edu.cn">202312620009@nuist.edu.cn</a></p>
      <p>💻 <a href="https://github.com/MapleMemories">github.com/MapleMemories</a></p>
      <hr style="margin: 10px 0; opacity: 0.3">
      <p><strong>🔬 Research</strong><br>Robot Visual Perception<br>Computer Vision<br>Point Cloud Segmentation</p>
    </div>
  </div>

  <div style="flex: 1; min-width: 300px;">
    <h1 style="margin-top: 0;">Hi there! 👋 I'm Ruifeng Han</h1>
    <p>Welcome to my GitHub homepage! I'm a Master's Candidate in Artificial Intelligence at Nanjing University of Information Science and Technology (NUIST), passionate about advancing research in computer vision and 3D data processing.</p>
